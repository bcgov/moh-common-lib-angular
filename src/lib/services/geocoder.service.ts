...
export class GeocoderService extends AbstractHttpService {
    ...
    lookup(address: string): Observable<GeoAddressResult[]> {
        ...
        return this.get<{ features: any }>(this.ADDRESS_URL, params).pipe(map(this.processResponse));
    }
     ...
     */
    protected processResponse(obj: { features: any; }): GeoAddressResult[] {
        return obj.features.map((feature: { properties: any; }) => {
